...
function Modal() {
  ...
  // This function is used to create and store comments to the backend just as we did with creating the post
                    ...
                    <div className="flex-grow mt-2">
                      ...
                      {calendar && (
                        <div className="h-11 w-full text-gray-500">
                          <p>📅 Calendar curruntly not available </p>
                        </div>
                      )}
                      {file && (
                        <div className="h-11 w-full text-gray-500">
                          <p>📁 Text only on this section </p>
                        </div>
                      )}
                      {showEmojis && (
                        <div className="h-11 w-full text-gray-500">
